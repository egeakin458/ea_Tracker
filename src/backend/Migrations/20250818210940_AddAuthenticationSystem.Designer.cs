...
namespace ea_Tracker.Migrations
{
    ...
    [Migration("20250818210940_AddAuthenticationSystem")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ea_Tracker.Models.RefreshToken", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ea_Tracker.Models.Role", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ea_Tracker.Models.User", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ea_Tracker.Models.UserRole", b =>
                {
                    b.Property<int>("UserId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ea_Tracker.Models.Waybill", b =>
                {
                    ...
                    b.HasIndex("DueDate")
                        .HasDatabaseName("IX_Waybill_DueDate");
            ...
            modelBuilder.Entity("ea_Tracker.Models.RefreshToken", b =>
                {
                    b.HasOne("ea_Tracker.Models.User", "User")
            ...
            modelBuilder.Entity("ea_Tracker.Models.UserRole", b =>
                {
                    b.HasOne("ea_Tracker.Models.Role", "Role")
                        .WithMany("UserRoles")
